      ...
      <div className="container grid laptop:grid-cols-[35%,50%] laptop:gap-[15%] tablet:grid-cols-[1fr] tablet:gap-0 tablet:m-auto">
        ...
        <div className="text-center relative left-5 laptop:block">
          ...
          <p className="text-sm my-6 mx-0 text-custom-light tablet:m-[1rem,0,1.5rem] laptop:mt-8 laptop:mb-10 laptop:mx-0 text-left">
            ...
            international financial tech company based in Indonesia. I have 5-6
            years experience as a frontend software engineer. Including several
            years working as a Frontend Lead. I have a BS degree in Computer
